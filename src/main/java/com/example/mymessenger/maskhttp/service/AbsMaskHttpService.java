...
public abstract class AbsMaskHttpService extends BaseBean implements IMaskHttpService {
    ...
    public enum MaskHttpURL {
        _stores_json(
                ...
                HttpMethodType.GET, MediaType.APPLICATION_JSON, StoreResult.class,
                "/stores/json",
        ...
        _sales_json(
                ...
                HttpMethodType.GET, MediaType.APPLICATION_JSON, SaleResult.class,
                "/sales/json",
                /*페이지 번호(default value:1)*/"page",
                /*한 페이지당 출력할 판매처 수[default: 500, min:500, max:5000]*/"perPage"),
        ...
        _storesByGeo_json(
                ...
                HttpMethodType.GET, MediaType.APPLICATION_JSON, StoreSaleResult.class,
                "/storesByGeo/json",
        ...
        private HttpMethodType requestHttpMethodType;
        private MediaType responseMediaType;
        private Class<?> responseMaskSchema;
        private String requestUrl;
        private String[] requestParams;

        <T extends IMaskSchema> MaskHttpURL(String description, HttpMethodType requestHttpMethodType, MediaType responseMediaType, Class<T> responseMaskSchema,
                                            String requestUrl, String ... requestParams) {
            this.description = description;
            this.requestHttpMethodType = requestHttpMethodType;
    ...
    public HttpResponse<String> request(Map<Object, Object> params) throws Exception {
        return httpGateService.getHttpService(getMaskHttpUrl().getRequestHttpMethodType())
